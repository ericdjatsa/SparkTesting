...
/usr/lib/spark/bin/spark-submit --class com.airline.PredictDelayStreaming --master yarn --deploy-mode cluster --conf spark.yarn.jar=$SPARK_ASSEMBLY_JAR ../../../target/sparkairline-0.0.1-SNAPSHOT.jar streaming output/airline.model results

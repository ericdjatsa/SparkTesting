...
$SPARK_SETUP_DIR/startnode.sh -n "master" -v $REPO_ROOT_DIR/spark-use-cases/bookingsanalysis:/opt/bookingsanalysis -v $REPO_ROOT_DIR/spark-use-cases/airlinedemo:/opt/airlinedemo -v /tmp/ansible-share:/tmp/ansible-share &
